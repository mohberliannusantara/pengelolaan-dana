    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="<?php base_url('admin/sumberdana/create/') ?>" method="post" enctype="multipart/form-data">

              <div class="form-group">
                <label for="id_jenis_sekolah">Nama Sekolah: </label>
                ...
                <div class="invalid-feedback">Masukkan Nama Sekolah.</div>
              </div>
