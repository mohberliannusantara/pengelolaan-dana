          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                <a class="dropdown-item" href="<?php echo base_url('pengguna/gantiPass'). $this->session->id_pengguna ?>"  data-toggle="modal" data-target="#change_password">Ganti Password</a>
