        ...
        <div class="card card-profile">
          <div class="card-body dropdown show">
            <h4 class="card-title">BOS-04</h4>
              <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#BOS-04">Unduh</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url().'pengeluaran/export/'.$this->session->id_sekolah ?>" method='post'>
